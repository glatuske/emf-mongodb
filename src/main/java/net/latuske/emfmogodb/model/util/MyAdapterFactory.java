/**
 */
package net.latuske.emfmogodb.model.util;

import net.latuske.emfmogodb.model.*;
 ...
 * <!-- end-user-doc -->
 * @see net.latuske.emfmogodb.model.MyPackage
 * @generated
 */
public class MyAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.latuske.emfmogodb.model.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.latuske.emfmogodb.model.Address <em>Address</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
